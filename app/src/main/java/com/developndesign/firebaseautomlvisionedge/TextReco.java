...
public class TextReco extends AppCompatActivity {
    TextView textView;
    Button button;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.activity().start(TextReco.this);
            }
        });
    }
    @Override
    ...
    private void extractTextFromImage(Uri uri) throws IOException {
        ...
        FirebaseVisionImage image = FirebaseVisionImage.fromFilePath(TextReco.this, uri);
